...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (function initializeCounselorsCalendar() {
    ...
    async function fetchDayDetails(dateStr) {
      ...
      try {
        const url = new URL(
          (window.BASE_URL || "/") + "student/calendar/day-details"
        );
    ...
    async function openDayTooltip(dateStr, anchorEl) {
      ...
      items.forEach((item) => {
        const kindLabel =
          item.kind === "follow_up" ? "Follow-up Session" : "Appointment";
        ...
        row.innerHTML = `
          ...
          <div class="tooltip-item-detail"><strong>Student:</strong> ${
            item.student_name || "Student"
          }</div>
          <div class="tooltip-item-detail"><strong>Counselor:</strong> ${
            item.counselor_name || "No Preference"
          }</div>
          <div class="tooltip-item-detail"><strong>Method:</strong> ${
