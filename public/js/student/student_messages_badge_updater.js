// Student Messages Badge Updater - Updates unread messages count badge in sidebar

(function() {
    'use strict';

    const BADGE_ID = 'student-messages-badge';
    const API_ENDPOINT = 'student/message/operations?action=get_unread_count';
    ...
    function updateBadge() {
        ...
        .then(data => {
            if (data.success && typeof data.unread_count === 'number') {
                ...
                console.warn('[Student Messages Badge] Invalid response format:', data);
            }
        })
        .catch(error => {
            console.error('[Student Messages Badge] Error updating badge:', error);
    ...
    window.updateStudentMessagesBadge = updateBadge;
})();
