// Counselor Notifications Badge Updater - Updates unread notifications count badge in sidebar

(function() {
    'use strict';

    const BADGE_ID = 'counselor-notifications-badge';
    const API_ENDPOINT = 'counselor/notifications/unread-count';
    ...
    function updateBadge() {
        ...
        .then(data => {
            if (data.status === 'success' && typeof data.unread_count === 'number') {
                ...
                console.warn('[Counselor Notifications Badge] Invalid response format:', data);
            }
        })
        .catch(error => {
            console.error('[Counselor Notifications Badge] Error updating badge:', error);
    ...
    window.updateCounselorNotificationsBadge = updateBadge;
})();
