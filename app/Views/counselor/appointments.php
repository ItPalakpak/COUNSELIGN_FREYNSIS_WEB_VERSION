...
<body>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-dark">
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                            ...
                            <li>
                                    <a href="<?= base_url('counselor/appointments/scheduled') ?>"><i class="fas fa-calendar-alt me-1"></i>Scheduled Appointments</a>
                                </li>
                                <li>
    ...
    <div class="counselor-navbar-drawer d-lg-none" id="counselorNavbarDrawer">
        ...
        <li class="nav-item"><a class="nav-link" href="<?= base_url('counselor/appointments/scheduled') ?>"><i class="fas fa-calendar-alt me-1"></i>Scheduled Appointments</a></li>
